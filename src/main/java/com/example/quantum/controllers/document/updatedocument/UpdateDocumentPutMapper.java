...
public class UpdateDocumentPutMapper {
    ...
    // Request → Input
    public static UpdateDocumentPutInput toDocumentInput(UUID documentId, UpdateDocumentPutRequest request) {
    ...
    // Domain → Response
    public static UpdateDocumentPutResponse toDocumentResponse(Document document) {
